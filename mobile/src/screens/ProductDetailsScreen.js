...
const styles = StyleSheet.create({
  ...
  topBar: { height: 84, paddingHorizontal: 18, backgroundColor: '#fff', flexDirection: 'row', alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#e5e9ed' },
  ...
  topBarTitle: { flex: 1, color: '#151b24', fontSize: 18, fontWeight: '800', marginLeft: 12 },
  ...
  meta: { color: '#69727e', backgroundColor: '#f6f7f8', padding: 7, borderRadius: 6, fontSize: 12 },
